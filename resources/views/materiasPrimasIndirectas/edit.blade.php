...
@section('content')
    <div class="p-12">
        <div class="container">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('materiasPrimasIndirectas.update', $materia_Prima_indirecta->id) }}"  method="POST" class="max-w-sm mx-auto space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="precio_unit" id="precio_unit" value="{{ $materia_Prima_indirecta->precio_unit }}" class="bg-gray-900 border border-gray-300 text-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
