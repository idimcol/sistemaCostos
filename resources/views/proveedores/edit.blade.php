...
<div class="container">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('proveedor.update', $proveedor->id) }}" method="POST" class="max-w-sm mx-auto space-y-4">
                @csrf
                @method('PUT')

                <div>
                    <label class="form-label" for="nit">NIT</label>
                    <input type="text" name="nit" id="nit" value="{{ $proveedor->nit }}" class="form-control" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="persona_contacto" value="{{ $proveedor->persona_contacto }}" id="persona_contacto" class="form-control" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="telefono" id="telefono" value="{{ $proveedor->telefono }}" class="form-control" required>
                </div>
