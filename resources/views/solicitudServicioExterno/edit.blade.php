...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('SSE.update', $solicitudServicioExterno->numero_ste) }}" method="POST" class="max-w-sm mx-auto space-y-4">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="numero_ste" class="form-label">numero SSE</label>
                    <input type="text" name="numero_ste" value="{{ $solicitudServicioExterno->numero_ste }}" class="form-control" readonly>
                </div>
                ...
                <div class="items-container group-form mb-4" id="items-container">
                    ...
                    @foreach ($itemsSte as $item)
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control item-servicio_requerido" name="items[{{ $loop->index }}][servicio_requerido]" value="{{ $item->servicio_requerido }}" readonly>
                        </div>

                        <div class="form-group">
                            <label for="">Dureza HRC</label>
                            <input type="text" class="form-control item-dureza_HRC" name="items[{{ $loop->index }}][dureza_HRC]" value="{{ $item->dureza_HRC }}" readonly>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="observaciones" value="{{ $solicitudServicioExterno->observaciones }}" class="form-control">
                </div>

                <div class="form-group">
                    <label for="despacho">despachado por</label>
                    <input type="text" name="despacho" value="{{ $solicitudServicioExterno->despacho }}" class="form-control">
                </div>

                <div class="form-group">
                    <label for="fecha_salida_planta" class="form-label">fecha de salida de planta</label>
                    <input type="date" name="fecha_salida_planta" class="form-control" value="{{ $solicitudServicioExterno->fecha_salida_planta }}">
                </div>
                    ...
                    <select name="departamento" id="departamento" class="form-control">
                        @foreach (App\Enums\Departamento::cases() as $departamento)
                            <option value="{{ $departamento->value }}"
                                {{ $solicitudServicioExterno->departamento === $departamento ? 'selected' : '' }}>
                                {{ $departamento->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="recibido" value="{{ $solicitudServicioExterno->recibido }}" class="form-control">
                </div>
