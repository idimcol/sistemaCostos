            ...
            <div class="card-body">
                <form action="{{ route('Ordencompras.store') }}" method="POST" class="max-w-sm mx-auto space-y-4 mb-4">
                    ...
                    <div class="">
                        ...
                        <button type="button" id="btn-add-item" class="btn btn-primary mt-2">Agregar item</button>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function additemRow() {
                ...
                row.innerHTML = `
                    ...
                    <div class="mb-4">
                        <input type="number" class="form-control item-cantidad" name="items[${itemIndex}][cantidad]" placeholder="Cantidad" min="1">
                        <input type="hidden" name="items[${itemIndex}][id]" class="item-id">
                    </div>

                    <div class="mb-4">
                        <input type="number" class="form-control item-precio" name="items[${itemIndex}][precio]" placeholder="Precio" min="0" step="0.01">
                    </div>
            ...
            // Manejar el clic en el botón para agregar un item
